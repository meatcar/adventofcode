...
const compass = Object.keys(Headings); // north, south, etc

const startingHeading = headings.N;

function solution(curHeading, distance, directions) {
    if (directions.length === 0) {
        return distance;
    }
    const [direction, ...rest] = directions;
    const newHeading = // index + 1 %4 for right, -1 for left.
}
